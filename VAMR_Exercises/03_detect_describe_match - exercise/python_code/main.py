...
if __name__=="__main__":
    ...
    #keypoints = np.array(selectKeypoints(harris_scores, num_keypoints, nonmaximum_supression_radius))
    '''
    plt.clf()
    plt.close()
    ...
    #descriptors = np.array(describeKeypoints(img, keypoints, descriptor_radius))
    '''
    plt.clf()
    plt.close()
